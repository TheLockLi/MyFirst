  ...
  <h1>个人信息查看及修改</h1>
  	...
  	<div id="body">
		    	...
		    	<tr>
		    		...
		    		<td colspan="5">
		    			 	<input id="time"type="text" style="width:121px;" name="birthday"
	   							onclick="WdatePicker({el:this,isShowOthers:true,dateFmt:'yyyy-MM-dd'});" value="<fmt:formatDate value="${teacherInfo.birthday}" pattern="yyyy-MM-dd"/>"/>
		    		</td>
		    	</tr>
		    	<tr>
		    		<td>民族</td>
		    		...
		    		<td>政治面貌</td>
		    		<td><input class=input-small type="text" name="political"  value="${teacherInfo.political }"/></td>
		    		<td>学历</td>
	    ...
	    <div class="info">
		    ...
		    <table>
			    <tr>
				  	<td><textarea rows="8" cols="130" name="sField" >${teacherInfo.sField }</textarea></td>  
				</tr>
			</table>
		</div>
	    <div class="info">
		    ...
		    <table>
			    <tr>
				  	<td><textarea rows="8" cols="130" name="specialty" >${teacherInfo.specialty }</textarea></td>  
				</tr>
			</table>
		</div>
	    <div class="info">
		    ...
		    <table>
			    <tr>
				  	<td><textarea rows="8" cols="130" name="remarks" >${teacherInfo.remarks }</textarea></td>  
				</tr>
			</table>
		</div>
