...
<html>
  <head>
    ...
    <script type="text/javascript" charset="utf-8" src="../js/ueditor/lang/zh-cn/zh-cn.js"></script>
     <script type="text/javascript">
        ...
        function save() {
    		checkForm();
    		document.getElementById("from").action="tosaveOReport.action";
    		document.forms.from.submit();
		}
	    	function checkForm() {
	    		var flag = true;
	    		flag=checkUE("yjyy",350,"研究意义不得多于350字")&&flag;
	    		flag=checkUE("jbnr",350,"基本内容不得多于350字")&&flag;
  ...
  <body>
	<div id="task">
		<form id="from" action="/updateOReport.action" method="post"  onsubmit="return checkForm()">
