  ...
  <body>
	<div id="task">
					...
					<input type="text" name="ktbh" readonly="readonly"
						value="${dProject.ktbh}" />
					<br/>
					&nbsp;&nbsp;&nbsp;&nbsp;审核日期：<fmt:formatDate value="${dProject.shrq}" pattern="yyyy-MM-dd"/>
					签署日期：<fmt:formatDate value="${dProject.qsrq}" pattern="yyyy-MM-dd"/>
					发放日期：<fmt:formatDate value="${dProject.ffrq}" pattern="yyyy-MM-dd"/>
			<div class="info">
					<span>设计目的</span><br />
					<br />
					<table>
						<tr>
							<td ><script id="sjmd" name="sjmd"
									type="text/plain"> ${dProject.sjmd}</script></td>
						</tr>
					</table>
				</div>
				<div class="info">
					...
					<table>
						<tr>
							<td ><script id="nryq" name="nryq"
									type="text/plain">${dProject.nryq} </script></td>
						</tr>
					</table>
				</div>
				<div class="info">
					...
					<table>
						<tr>
							<td ><script id="cgyq" name="cgyq"
									type="text/plain" >${dProject.cgyq} </script></td>
						</tr>
					</table>
				</div>
				<div class="info">
					...
					<table>
						<tr>
							<td ><script id="ckwx" name="ckwx"
									type="text/plain">${dProject.ckwx} </script></td>
						</tr>
					</table>
				</div>
				<div class="info">
					...
					<table>
						<tr>
							<td ><script id="jdap" name="jdap"
									type="text/plain">${dProject.jdap} </script></td>
						</tr>
					</table>
				</div>
				<div class="info">
					...
					<table>
						<tr>
							<td ><script id="shyj" name="shyj"
									type="text/plain"> ${dProject.shyj}</script></td>
						</tr>
					</table>
				</div>
